        ...
        <div className="mb-2 flex items-center gap-4 p-4">
            ...
            <Typography variant="h5" className="text-gray-300">
              ...
              <Alert open={openAlert} className="mt-auto bg-blue-gray-900" onClose={() => setOpenAlert(false)}>
                  <CubeTransparentIcon className="mb-4 h-12 w-12  hover:text-black" />
                  <Typography variant="h6" className="mb-1  hover:text-black">
                      Upgrade to PRO
                  </Typography>
                  <Typography variant="small" className="font-normal  hover:text-black">
                  ...
                  <div className="mt-4 flex gap-3">
                      ...
                      <Typography as="a" href="#" variant="small" className="font-medium  hover:text-black">
                          Upgrade Now
                      </Typography>
                  </div>
              </Alert>
