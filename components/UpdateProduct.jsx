...
const ProductFormSkel = ({ handleOpen, open, productId }) => {
    console.log("🚀 ~ file: UpdateProduct.jsx:20 ~ fetchProducts ~ productId:", productId)
    ...
    // useEffect(() => {
    //   console.log("🚀 ~ file: UpdateProduct.jsx:39 ~ useEffect ~ products:", products)
    //   console.log("🚀 ~ file: UpdateProduct.jsx:31 ~ fetchProducts ~ setDescription:", imageUrls)
